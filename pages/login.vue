  ...
  <div class="min-h-screen flex items-center justify-center">
    <section class="relative py-6 sm:py-10">
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        ...
        >Travel App</a> 
        <UCard class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <UForm
            :validate="validate"
            :state="state"
          ...
          >
            ...
            <div class="flex items-start">
              <label class="text-sm rtl:text-right font-medium text-gray-900 dark:text-gray-300 flex items-center mr-32"><input
                type="checkbox"
